...
public class DbConnectionResource {
    ...
    @GET
    @Path("/{miniapp}")
    public List<UserConnectorConfigDto> getConnectionByMiniApp(@PathParam("miniapp") String miniapp){
        return dbConnectionDetailsService.getConnectionByMiniAppName(miniapp);
    }
